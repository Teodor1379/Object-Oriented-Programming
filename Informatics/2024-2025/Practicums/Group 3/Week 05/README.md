...
## Задача 1 ![Static Badge](https://img.shields.io/badge/easy-green)
...
Създайте и функции в програмата си, които изчисляват разстоянието между две точки по *Евклид*, по *Манхатън*, по *Чебишов* (отделно за минимум и максимум).
...
Приемете, че максималната дължина на име на човек е `255` символа, като това правило важи и за първото име, и за последното име.
