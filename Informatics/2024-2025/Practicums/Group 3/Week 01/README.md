...
Създайте програма, която прочита от стандартния вход символен низ и криптира текста според шифъра на Цезар, извеждайки криптирания текст на стандартния изход. Шифърът не Цезар е метод на субституция на буквите, при който всеки символ от латинската азбука се заменя със символа от латинската азбука на `Shift` позиции след текущия.
